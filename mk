...
local Library = Update:Window("Hentxz","6023426909",Enum.KeyCode.RightControl);
...
Du = Library:Tab("ดูไรอะ อย่าเสือกได้ป่ะ")

Main:Line()

Main:Label("Welcome To BexCist Hub Community")
...
Main:Toggle("Bring Mob",true,function(Mag)
    ...
    Main:Toggle("Ultra Bring Mob [lag] ",true,function(value)
...
Main:Toggle("Fast Attack ",nil,function(value)
        _G.FastAttack = value
    end) 
  
Main:Toggle("Fast Attack[2]",true,function(value)
        _G.FastAttack2 = value
    end)   
    
Main3:Toggle("Fast Attack[3]",nil,function(value)
...
spawn(function()
    ...
    Main:Toggle("Remove Attack",true,function(value)
...
spawn(function()
    ...
    Main:Button("Delete DamageCounter", function()
...
Main:Toggle("Auto Click",getgenv().AutoClick,function(value)
...
Main:Toggle("Lock Level Farm",locklevel,function(value)
		...
		while wait(.1) do
			if LockLevel then
				if game.Players.localPlayer.Data.Level.Value >= LockLevelValue then
					game.Players.localPlayer:Kick("เวลแม็กละไอควาย")
				end
			end
		end
	end)
   ...
   Main:Line()
    ...
    M:Toggle("Auto law (New !)", _G.AutoOderSword,function(value)
         _G.AutoOderSword = value
        StopTween( _G.AutoOderSword)
    end)
    
    M:Toggle("Auto law hop", _G.AutoOderSwordHop,function(value)
    ...
    M:Button("Buy Microchip law boss",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    M:Button("Start Go To Raid law Boss",function()
        if World2 then
...
Misc:Button("Color Haki",function()
    ...
    Misc:Dropdown("Selected Codes Reset stat",{"1MLIKES_RESET","THIRDSEA","SUB2GAMERROBOT_RESET1","SUB2UNCLEKIZARU"},function(value)
        _G.CodeSelect = value
    end)
